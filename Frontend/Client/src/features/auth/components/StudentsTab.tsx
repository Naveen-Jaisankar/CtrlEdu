    ...
    const fetchClassData = async () => {
        ...
        try {
            ...
            const filteredClasses = classResponse.data.filter((classItem: Class) =>
                classItem.moduleIds.some(moduleId => teacherModuleIds.includes(moduleId))
            );
                ...
                <table className="table-auto w-full border-collapse border border-gray-700">
                    <thead>
                        <tr className="bg-neutral-800">
                            ...
                            <th className="border border-gray-600 px-4 py-2">Number of Students</th>
                        ...
                        {classes.length > 0 ? (
                            classes.map((classItem) => (
                                <tr key={classItem.classId}>
                                    <td className="border border-gray-600 px-4 py-2">{classItem.className}</td>
                                    <td className="border border-gray-600 px-4 py-2">{classItem.numStudents}</td>
                                    <td className="border border-gray-600 px-4 py-2">{classItem.moduleNames.join(", ")}</td>
                            ...
                            <tr>
                                <td colSpan={4} className="text-center border border-gray-600 px-4 py-2">
